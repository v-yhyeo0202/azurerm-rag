...
if dictConfig['bReset'] and  os.path.exists(dictConfig['path']['database']):
    shutil.rmtree(dictConfig['path']['database'])
...
listChunk = []
'''
dirPath = pathlib.Path(os.path.join(dictConfig['path']['home'], dictConfig['path']['azurerm'], 'internal'))
...
'''
df = pd.read_csv(os.path.join(dictConfig['path']['data'], 'chunkLine.csv'))
